    ...
    <main className="min-h-screen bg-black text-neutral-100">
      ...
      <div className="grid grid-cols-[250px_minmax(0,1fr)_250px] max-[1180px]:grid-cols-[250px_minmax(0,1fr)] max-[820px]:block">
        <aside className="sticky top-[74px] h-[calc(100vh-74px)] overflow-auto px-7 py-6 max-[820px]:static max-[820px]:h-auto max-[820px]:px-5">
          ...
          <p className="mb-6 text-sm leading-6 text-neutral-500">외부 보안 소프트웨어와 맞춤형 출입통제 예제입니다.</p>
        </aside>
        <article className="w-full max-w-[1180px] px-9 pb-20 pt-8 max-[820px]:px-5">
          <section className="scroll-mt-24" id="overview">
            <p className="mb-3 text-xs font-medium uppercase tracking-wide text-neutral-600">BioStar X Examples</p>
            <h1 className="mb-4 text-[42px] font-[560] leading-tight text-neutral-100 max-[760px]:text-[32px]">BioStar X 사용 예</h1>
            <p className="max-w-3xl text-[17px] leading-8 text-neutral-400">BioStar X API를 기존 시스템 통합, 맞춤형 출입통제, 원격 사이트 운영 흐름으로 정리합니다.</p>
          </section>
